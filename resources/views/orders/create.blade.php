                    ...
                    <form action="{{ route('orders.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <select id="product_id" class="w-full p-2 border border-gray-300 rounded-md">
                                    <option value="" selected>Selecione...</option>
                                    @foreach ($products as $product)
                                    <option value="{{ $product->id }}">{{ $product->name }}</option>
                                    @endforeach
                                </select>
                                <input type="number" id="quantity" class="w-full p-2 border border-gray-300 rounded-md" placeholder="Quantidade">
                                <input type="number" id="price" class="w-full p-2 border border-gray-300 rounded-md" placeholder="Preço">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <select id="payment_method" class="w-full p-2 border border-gray-300 rounded-md">
                                    <option value="" selected>Selecione...</option>
                                ...
                                <input type="number" id="installment_count" class="w-22 p-2 border border-gray-300 rounded-md hidden" placeholder="Parcelas">
                            ...
                            <div class="border border-gray-300 rounded-md p-2 w-full">
                                <table class="w-full">
                                    ...
                                    <tbody id="payments_table" class="py-4 border-t border-gray-300">
                                        <tr>
                                            <td colspan="3" class="text-center text-gray-500 py-4">Nenhum pagamento adicionado</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
